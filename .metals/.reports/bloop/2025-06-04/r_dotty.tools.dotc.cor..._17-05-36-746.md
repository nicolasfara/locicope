error id: RIFZL+rzXpUa48HXNYvn2w==
### Bloop error:

dotty.tools.dotc.core.Denotations$StaleSymbolException: stale symbol; module class Multitier$#4500 in module class locicope, defined in Period(2.1-53), is referred to in run Period(3.1)
...
dotty.tools.dotc.core.Denotations$StaleSymbolException: stale symbol; module class Multitier$#4500 i...
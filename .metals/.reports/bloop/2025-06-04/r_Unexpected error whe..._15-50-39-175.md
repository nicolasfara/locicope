error id: V3Ei0/ns5u4D7eEdge33lw==
### Bloop error:

Unexpected error when compiling core.scoverage: dotty.tools.dotc.core.Denotations$StaleSymbolException: stale symbol; class PlacementImpl#4508 in module class locicope, defined in Period(2.1-78), is referred to in run Period(3.1)

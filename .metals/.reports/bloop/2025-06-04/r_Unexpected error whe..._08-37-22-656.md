error id: RAsHFUiU1A4i9mxXAefniQ==
### Bloop error:

Unexpected error when compiling core: dotty.tools.dotc.core.Denotations$StaleSymbolException: stale symbol; class PlacementImpl#4519 in module class locicope, defined in Period(2.1-77), is referred to in run Period(3.1)

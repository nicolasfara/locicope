error id: KqcuP55oiSFbdCKMR29rrA==
### Bloop error:

Unexpected error when compiling core.scoverage: dotty.tools.dotc.core.Denotations$StaleSymbolException: stale symbol; class PlacementImpl#4513 in module class locicope, defined in Period(2.1-78), is referred to in run Period(3.1)
...
Unexpected error when compiling core.scoverage: dotty.tools.dotc.core.Denotations$StaleSymbolExcepti...
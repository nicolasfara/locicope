error id: file://<WORKSPACE>/core/src/io/github/locicope/Multitier.scala:astHash.
file://<WORKSPACE>/core/src/io/github/locicope/Multitier.scala
empty definition using pc, found symbol in pc: astHash.
...
non-local guesses:
	 ...
	 -AstHashing.astHash#
	 -AstHashing.astHash().
	 -scala/Predef.AstHashing.astHash.
	 -scala/Predef.AstHashing.astHash#
	 -scala/Predef.AstHashing.astHash().
offset: 3256
...
object Multitier:
  ...
  trait Placement(using network: Network):
     ...
     */
    def placed[V: Encoder, P <: Peer](body: PlacedLabel[P] ?=> V): V on P =
      val hasedAst = AstHashing.a@@stHash(body)
  ...
  object Placement:
     ...
     * Represents a "placed computation", i.e., a function or a value that is defined in the context of the peer [[P]].
     */
    def placed[P <: Peer](using p: Placement)[V: Encoder](body: p.PlacedLabel[P] ?=> V): V on P = p.placed[V, P](body)
